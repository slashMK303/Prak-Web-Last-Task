...
<body class="bg-gray-100 p-6">
    ...
    <div class="space-x-4">
        <a href="../buku/index.php" class="bg-blue-500 text-white px-4 py-2 rounded">Manajemen Buku</a>
        <a href="../member/index.php" class="bg-green-500 text-white px-4 py-2 rounded">Data Member</a>
        <a href="../peminjaman/index.php" class="bg-purple-500 text-white px-4 py-2 rounded">Riwayat Peminjaman</a>
    </div>
</body>
